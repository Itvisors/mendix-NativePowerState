...
public class NativeAppContext
{
	...
	public static testpowerstate.proxies.NativeAppContext initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return testpowerstate.proxies.NativeAppContext.load(context, mendixIdentifier);
	}
